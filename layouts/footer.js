...
export default function Footer() {
    return (
        <>
            <footer className="wbevent_fn_footer">
                            ...
                            <div className="inner">
                                <ul className="widget_area">
                                    <li>
                                        <div className="item">
                                            <div className="logo">
                                                <Link href="/"><img src="/img/WB Event Structures_Logo_RGB.png" alt="" /></Link>
                                            </div>
                                            <div className="textwidget">
                                                <p>Elevating Spaces, Exceeding Expectations
                                                </p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="item">
                                            ...
                                            <div className="wbevent_fn_widget_business_hours">
                                                <div>
                                                    <ul>
                                                        <li>
                    ...
                    <div className="container">
                        <div className="footer_bottom_in">
                            ...
                            <div className="footer_copyright">
                                <p>&copy; 2024 WB Events LLC. All rights reserved.</p>
                            </div>
                            <Link href="#" className="wbevent_fn_totop">
